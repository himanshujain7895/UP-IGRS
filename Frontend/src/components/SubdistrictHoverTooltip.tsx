/**
 * Subdistrict Hover Tooltip Component
 * Displays a quick summary of subdistrict information on hover
 * Shows BDO, Block Pramukh, complaint stats, and demographics
 */
...
interface SubdistrictHoverTooltipProps {
...
export const SubdistrictHoverTooltip: React.FC<SubdistrictHoverTooltipProps> = ({
  subdistrictName,
  position,
  data,
  loading = false,
            ...
            <div className="space-y-2 text-sm">
              ...
              {data.bdoName && (
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{data.bdoName}</span>
                </div>
              )}
              
              {data.blockPramukh && (
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Block Pramukh:</span>
                  <span className="font-medium">{data.blockPramukh}</span>
                </div>
              )}

              {/* Divider */}
              {(data.bdoName || data.blockPramukh) && (
